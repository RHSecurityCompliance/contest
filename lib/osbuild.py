...
# e.g. STIG which uses 10 GiB /var/log/audit partition because of DISA requirements.
# The qcow2 image generated by composer-cli is sparse, so actual disk usage is much smaller.
